          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {features?.map((feature, idx) => {
              return (
                <Card
                  key={idx}
                  className="border-2 hover:border-primary transition-colors duration-300 cursor-pointer"
                >
                  ...
                  <CardContent className="pt-2">
                    <div className="flex flex-col space-y-4">
                      <div className="flex items-center space-x-4 ">
                        ...
                        <Image className="rounded-full object-cover border-2 border-primary/20" src={test?.image} width={40} height={40}  alt={test?.author} /></div>
                        <div>
